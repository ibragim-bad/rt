...
void	init_ui(t_rtui *ui)
{
	...
	kiss_entry_new(&ui->entry, &ui->window1, 1, "kiss", ui->textbox1.rect.x,
		ui->label_sel.rect.y + kiss_textfont.lineheight,
		2 * ui->textbox_width + 2 * kiss_up.w + kiss_edge);
